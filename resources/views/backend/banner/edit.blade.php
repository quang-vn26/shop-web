...
@section('title','E-SHOP || Chỉnh sữa Quảng cáo')
@section('main-content')

<div class="card">
    <h5 class="card-header">Chỉnh sữa Quảng cáo</h5>
    <div class="card-body">
      <form method="post" action="{{route('banner.update',$banner->id)}}">
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            ...
            <option value="inactive" {{(($banner->status=='inactive') ? 'selected' : '')}}>Tạm hoãn</option>
          </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
