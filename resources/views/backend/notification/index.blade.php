...
@section('title','E-SHOP || Tất cả thông báo')
...
<div class="card">
  ...
  <h5 class="card-header">Các thông báo</h5>
  <div class="card-body">
    ...
    <table class="table  table-hover admin-table" id="notification-dataTable">
      ...
      <tbody>
        ...
        <tr class="@if($notification->unread()) bg-light border-left-light @else border-left-success @endif">
          ...
          <td>
            <a href="{{route('admin.notification', $notification->id) }}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:40px;border-radius:50%" data-toggle="tooltip" title="view" data-placement="bottom"><i class="fas fa-eye"></i></a>
    ...
    @else
      <h2>Không có thông báo nào cả</h2>
    @endif
  </div>
</div>
@endsection
      ...
      $.ajaxSetup({
        ...
        $('.dltBtn').click(function(e){
          var form=$(this).closest('form');
            ...
            swal({
                  title: "Chú ý",
                  text: "Khi đã xoá dữ liệu thì không thể khôi phục lại được nữa!",
                  icon: "warning",
                  buttons: true,
                  dangerMode: true,
              })
