                    ...
                    <div class="search-top">
                        ...
                        <div class="search-top">
                            <form class="search-form">
                                <input type="text" placeholder="Tìm kiém.." name="search">
                                ...
                                <div class="navbar-collapse">	
                                    <div class="nav-inner">	
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="@if(Request::path()=='product-grids'||Request::path()=='product-lists')  active  @endif"><a href="{{route('product-grids')}}">Sẩn phẩm</a><span class="new">Mới</span></li>												
