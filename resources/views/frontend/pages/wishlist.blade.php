							...
							@else 
								<tr>
									<td class="text-center">
										Không có danh sách yêu thích.<a href="{{route('product-grids')}}" style="color:blue;">Tiếp tục mua hàng</a>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6 col-12">
					...
					<div class="single-service">
						...
						<p>Đơn hàng quá 2.400.000.000 vnđ</p>
					</div>
					<!-- End Single Service -->
				</div>
				<div class="col-lg-3 col-md-6 col-12">
