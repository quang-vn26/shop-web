...
@section('title','E-SHOP || TRANG SẢN PHẨM')
                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="shop-sidebar">
                                ...
                                <div class="single-widget category">
                                    <h3 class="title">Các loại hàng hoá</h3>
                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="button-head">
                                                    <div class="product-action">
                                                        ...
                                                        <a title="Yêu thích" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class=" ti-heart "></i><span>Add to Yêu thích</span></a>
                                                    </div>
