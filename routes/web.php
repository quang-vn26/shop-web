...
Route::group(['prefix'=>'/admin','middleware'=>['auth','admin']],function(){
    ...
    // Product
    Route::resource('/product0','ProductController');
...
Route::group(['prefix'=>'/seller','middleware'=>['auth','seller']],function(){
    ...
    Route::get('/file-manager',function(){
        return view('seller.layouts.file-manager');
    })->name('seller-file-manager');
    ...
    Route::resource('/product','SellerProductController');    
});
